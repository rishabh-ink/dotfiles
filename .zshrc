...
if [[ -e "$ANTIGEN_HOME/antigen.zsh" ]]; then
    ...
    POWERLEVEL9K_OS_ICON_BACKGROUND=006 # "red"
    POWERLEVEL9K_OS_ICON_FOREGROUND=000 # "black"
    POWERLEVEL9K_CONTEXT_BACKGROUND=006 # "red"
    POWERLEVEL9K_CONTEXT_FOREGROUND=000 # "black"
    POWERLEVEL9K_STATUS_BACKGROUND=006 # "red"
    POWERLEVEL9K_STATUS_FOREGROUND=000 # "black"
    POWERLEVEL9K_DATE_BACKGROUND=033 # "blue"
    POWERLEVEL9K_DATE_FOREGROUND=000 # "black"
    POWERLEVEL9K_TIME_BACKGROUND=033 # "blue"
    POWERLEVEL9K_TIME_FOREGROUND=000 # "black"
    POWERLEVEL9K_VIRTUALENV_BACKGROUND=045 # "cyan"
    POWERLEVEL9K_VIRTUALENV_FOREGROUND=000 # "black"
    POWERLEVEL9K_VCS_BACKGROUND=227 # "yellow"
    POWERLEVEL9K_VCS_FOREGROUND=000 # "black"
    POWERLEVEL9K_NODE_VERSION_BACKGROUND=002 # "green"
    POWERLEVEL9K_NODE_VERSION_FOREGROUND=000 # "black"
    POWERLEVEL9K_DIR_BACKGROUND=005 # "magenta"
    POWERLEVEL9K_DIR_FOREGROUND=000 # "black"
